...
dfResultado.write.format("csv").option("header", "true").option("delimiter", "|").option("encoding", "ISO-8859-1").mode("overwrite").save("dbfs:///FileStore/_bigdata/dfResultadoText")

# COMMAND ----------

# MAGIC %fs ls dbfs:///FileStore/_bigdata/dfResultadoText

# COMMAND ----------

#Leemos
dfResultadoLeido = spark.read.format("csv").option("header", "true").option("delimiter", "|").option("encoding", "ISO-8859-1").load("dbfs:///FileStore/_bigdata/dfResultadoText")
...
# DBTITLE 1,5. Almacenamiento [Binario]
#Almacenamiento en formato binario
dfResultado.write.format("delta").option("compression", "snappy").mode("overwrite").save("dbfs:///FileStore/_bigdata/dfResultadoDelta")

# COMMAND ----------

# MAGIC %fs ls dbfs:///FileStore/_bigdata/dfResultadoDelta

# COMMAND ----------

#Leemos
dfResultadoLeido = spark.read.format("delta").load("dbfs:///FileStore/_bigdata/dfResultadoDelta")
