...
).load("dbfs:///FileStore/_pyspark/deltalake/bronze/transacciones_bancarias/")
...
dfTransaccionLimpio.write.format("delta").mode("overwrite").save("dbfs:///FileStore/_pyspark/deltalake/silver/transaccion/")
...
#Almacenamiento binarizado
dfEmpresaLimpio.write.format("delta").mode("overwrite").save("dbfs:///FileStore/_pyspark/deltalake/silver/empresa/")
...
#Almacenamiento binarizado
dfPersonaLimpio.write.format("delta").mode("overwrite").save("dbfs:///FileStore/_pyspark/deltalake/silver/persona/")
